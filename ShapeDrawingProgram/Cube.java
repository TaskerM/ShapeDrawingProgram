 ...
 * Author: Mark Tasker 
 * Date: 2/9/20
 * Purpose: File contains the Cube shape class.
 */
...
public class Cube implements Shape {
    ...
    /**
     * Function responsible for drawing the Cube in the context of the graphics
     * g2d.
     *
    ...
    public void drawSwing(Graphics2D g2d, Dimension size) {
        try {
            BufferedImage image = ImageIO.read(new File("imgs/cube.jpg"));
    ...
    public void getInputs(ArrayList<JPanel> textPanels) {
        length = Integer.parseInt(((JTextField) textPanels.get(0).getComponent(1)).getText());
    }
