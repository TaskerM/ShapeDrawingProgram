 ...
 * Author: Mark Tasker 
 * Date: 2/9/20
 * Purpose: File contains the Cylinder shape class.
 */
...
public class Cylinder implements Shape {
    ...
    /**
     * Function responsible for drawing the Cylinder in the context of the
     * graphics g2d.
     *
    ...
    public void drawSwing(Graphics2D g2d, Dimension size) {
        try {
            BufferedImage image = ImageIO.read(new File("imgs/cylinder.jpg"));
