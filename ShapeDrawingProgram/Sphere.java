 ...
 * Author: Mark Tasker 
 * Date: 2/9/20
 * Purpose: File contains the Sphere class.
 */
...
public class Sphere implements Shape {
    ...
    /**
     * Function responsible for Sphere the Rectangle in the context of the
     * graphics g2d.
     *
    ...
    public void drawSwing(Graphics2D g2d, Dimension size) {
        try {
            BufferedImage image = ImageIO.read(new File("imgs/sphere.jpg"));
